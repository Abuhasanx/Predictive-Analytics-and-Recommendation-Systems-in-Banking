...
svd = joblib.load(r"D:\1 DS PROJECTS\DS final project 1\scaler.pkl")
interaction_matrix = joblib.load(r"D:\1 DS PROJECTS\DS final project 1\scaler.pkl")
svd_similarity_df = joblib.load(r"D:\1 DS PROJECTS\DS final project 1\scaler.pkl")
